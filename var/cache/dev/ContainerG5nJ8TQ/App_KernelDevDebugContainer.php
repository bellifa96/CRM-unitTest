...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->methodMap = [
            'App\\Controller\\GroupUsersController' => 'getGroupUsersControllerService',
    ...
    /**
     * Gets the public 'App\Controller\GroupUsersController' shared autowired service.
     *
     * @return \App\Controller\GroupUsersController
     */
    protected function getGroupUsersControllerService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Controller/GroupUsersController.php';

        $this->services['App\\Controller\\GroupUsersController'] = $instance = new \App\Controller\GroupUsersController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Repository\\GroupUsersRepository'] ?? $this->getGroupUsersRepositoryService()));

        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\GroupUsersController', $this));
