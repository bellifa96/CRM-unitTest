...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getGroupControllerService()
    {
        ...
        $this->services['App\\Controller\\GroupController'] = $instance = new \App\Controller\GroupController(($this->services['doctrine.orm.default_entity_manager'] ?? $this->getDoctrine_Orm_DefaultEntityManagerService()), ($this->privates['App\\Repository\\GroupRepository'] ?? $this->getGroupRepositoryService()));

        $instance->setContainer(($this->privates['.service_locator.SXie53V'] ?? $this->get_ServiceLocator_SXie53VService())->withContext('App\\Controller\\GroupController', $this));
    ...
    protected function getGroupTypeService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/symfony/form/AbstractType.php';
        include_once \dirname(__DIR__, 4).'/src/Form/GroupUsersType.php';
