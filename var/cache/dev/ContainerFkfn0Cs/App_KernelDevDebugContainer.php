...
class App_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('8FMxpF1zcH', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ABgl81DyDF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\EntryRepository' => ['privates', 'App\\Repository\\EntryRepository', 'getEntryRepositoryService', false],
            'App\\Repository\\GroupUsersRepository' => ['privates', 'App\\Repository\\GroupUsersRepository', 'getGroupUsersRepositoryService', false],
            'App\\Repository\\MeRepository' => ['privates', 'App\\Repository\\MeRepository', 'getMeRepositoryService', false],
            ...
            'App\\Repository\\GroupUsersRepository' => '?',
            'App\\Repository\\MeRepository' => '?',
    ...
    /**
     * Gets the private '.service_locator.z6kWTPN' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_Z6kWTPNService()
    {
        return $this->privates['.service_locator.z6kWTPN'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Controller\\UserController::newAction' => ['privates', '.service_locator.8Z_jHRB', 'get_ServiceLocator_8ZJHRBService', false],
            'App\\Controller\\UserController::update' => ['privates', '.service_locator.VL.K2eC', 'get_ServiceLocator_VL_K2eCService', false],
            'App\\Controller\\SecurityController:login' => ['privates', '.service_locator.q6jLs_L', 'get_ServiceLocator_Q6jLsLService', false],
            'App\\Controller\\UserController:delete' => ['privates', '.service_locator.ClekQ8b', 'get_ServiceLocator_ClekQ8bService', false],
            'App\\Controller\\UserController:newAction' => ['privates', '.service_locator.8Z_jHRB', 'get_ServiceLocator_8ZJHRBService', false],
            'App\\Controller\\UserController:update' => ['privates', '.service_locator.VL.K2eC', 'get_ServiceLocator_VL_K2eCService', false],
    ...
    /**
     * Gets the private 'App\Repository\EntryRepository' shared autowired service.
     *
     * @return \App\Repository\EntryRepository
     */
    protected function getEntryRepositoryService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Repository/EntryRepository.php';

        return $this->privates['App\\Repository\\EntryRepository'] = new \App\Repository\EntryRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\GroupUsersRepository' shared autowired service.
     *
     * @return \App\Repository\GroupUsersRepository
     */
    protected function getGroupUsersRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/GroupUsersRepository.php';

        return $this->privates['App\\Repository\\GroupUsersRepository'] = new \App\Repository\GroupUsersRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }

    /**
     * Gets the private 'App\Repository\MeRepository' shared autowired service.
     *
     * @return \App\Repository\MeRepository
     */
    protected function getMeRepositoryService()
    {
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/persistence/lib/Doctrine/Persistence/ObjectRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/collections/lib/Doctrine/Common/Collections/Selectable.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/orm/lib/Doctrine/ORM/EntityRepository.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepositoryInterface.php';
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/doctrine-bundle/Repository/ServiceEntityRepository.php';
        include_once \dirname(__DIR__, 4).'/src/Repository/MeRepository.php';

        return $this->privates['App\\Repository\\MeRepository'] = new \App\Repository\MeRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
    }
    ...
    /**
     * Gets the private 'App\Security\AppUserAuthAuthenticator' shared autowired service.
     *
     * @return \App\Security\AppUserAuthAuthenticator
     */
    protected function getAppUserAuthAuthenticatorService()
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Security/AppUserAuthAuthenticator.php';

        return $this->privates['App\\Security\\AppUserAuthAuthenticator'] = new \App\Security\AppUserAuthAuthenticator(($this->services['router'] ?? $this->getRouterService()), ($this->services['security.csrf.token_manager'] ?? $this->getSecurity_Csrf_TokenManagerService()), ($this->services['security.password_encoder'] ?? $this->getSecurity_PasswordEncoderService()));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SeRQBy6oKj', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('mDkSzd2YAr', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dWSb24Jo6Z', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('xiMKTCfSbK', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3ISE5WzxJd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDebug_ArgumentResolver_NotTaggedControllerService()
    {
        ...
        return $this->privates['debug.argument_resolver.not_tagged_controller'] = new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\TraceableValueResolver(new \Symfony\Component\HttpKernel\Controller\ArgumentResolver\NotTaggedControllerValueResolver(($this->privates['.service_locator.z6kWTPN'] ?? $this->get_ServiceLocator_Z6kWTPNService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getSecurity_Authentication_Listener_Guard_MainService()
    {
        ...
        return $this->privates['security.authentication.listener.guard.main'] = new \Symfony\Component\Security\Guard\Firewall\GuardAuthenticationListener($a, ($this->privates['security.authentication.manager'] ?? $this->getSecurity_Authentication_ManagerService()), 'main', new RewindableGenerator(function () {
            yield 0 => ($this->privates['App\\Security\\AppUserAuthAuthenticator'] ?? $this->getAppUserAuthAuthenticatorService());
